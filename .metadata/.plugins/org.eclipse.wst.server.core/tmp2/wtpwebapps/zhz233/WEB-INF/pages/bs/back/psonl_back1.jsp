                    ...
                    <div class="assist-e-1-1-2 float-left">
                        <div class="assist-e-1-1-2-1">
                            <div class="assist-e-1-1-2-1-0">
                                ...
                                <div class="assist-e-1-1-2-1-0-1 float-left">
                                    <img src="img/bs_assist_reset_2.png" alt="reset_1.png">
                                    <br>重置密码
                                </div>
                                <div class="assist-e-1-1-2-1-0-1 float-left">
                                    <img src="img/bs_assist_reset_2.png" alt="reset_1.png">
                            ...
                            <div class="input-group assist-e-1-1-2-1-1">
                               <lable class="btn input-group-append"><span class="fa fa-mobile-phone"></span></lable>
                                <input class="form-control" type="text" placeholder="请输入手机号" id="user_phone">
                            </div>
                            <div class="input-group assist-e-1-1-2-1-1">
                                <lable class="btn input-group-append"><span class="fa fa-code"></span></lable>
                                <input class="form-control assist-e-1-1-2-1-1-1" type="text" placeholder="手机验证码" id="user_pcd">
                                <button class="btn input-group-append assist-e-1-1-2-1-1-2">获取短信验证码</button>
                            </div>
                            <div class="btn assist-e-1-1-2-1-2">
                                下一步
                            </div>
                            <div class="assist-e-1-1-2-2">
                                如果此号码已不再使用，请<a href="">联系客服</a>协助处理
                            </div>
                        </div>
                    </div>
