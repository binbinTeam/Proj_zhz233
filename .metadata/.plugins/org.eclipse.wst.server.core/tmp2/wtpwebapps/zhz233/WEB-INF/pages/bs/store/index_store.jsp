...
<div class="container-fluid">
    <div class="assist-img">
        <img class="img-fluid" src="img/st_store_bg_1.png" alt="bg_1.gif">
    </div>
</div>
<!-- img e -->
<!-- show-1 s -->
<div class="container-fluid store-a">
    <div class="container ">
        <div class="row store-a-0">
            <div class="store-a-1">
                <div class="store-a-1-1">
                    <div class="store-a-1-1-1">
                        <div class="store-a-1-1-1-1">
                            立即加入
                        </div>
                    </div>
                </div>
...
<!-- show-1 e -->
<!-- show-2 s -->
<div class="container-fluid store-b">
    <div class="container ">
        <div class="row store-b-0">
            <div class="store-b-1">
                <div class="store-b-1-1">
                    <div class="store-b-1-1-1 float-left">
                        <div class="store-b-1-1-1-1"><img src="img/st_store_bg2_4.png" alt="bg2_4.png"></div>
                        <div class="store-b-1-1-1-2"><span>自主管理</span><br>各个商家可自主管理账户，分配专门的管理系统</div>
                    </div>
                    <div class="store-b-1-1-1 float-left">
                        <div class="store-b-1-1-1-1"><img src="img/st_store_bg2_2.png" alt="bg2_2.png"></div>
                        <div class="store-b-1-1-1-2"><span>商户认证</span><br>发布商品通过系统验证后，专属的商户认证徽章</div>
                    </div>
                    <div class="store-b-1-1-1 float-left">
                        <div class="store-b-1-1-1-1"><img src="img/st_store_bg2_3.png" alt="bg2_3.png"></div>
                        <div class="store-b-1-1-1-2"><span>定制上号器</span><br>商家自主自定义特色上号器，打造专属上号器</div>
                    </div>
                    <div class="store-b-1-1-1 float-left">
                        <div class="store-b-1-1-1-1"><img src="img/st_store_bg2_1.png" alt="bg2_1.png"></div>
                        <div class="store-b-1-1-1-2"><span>自主管理</span><br>各个商家可自主管理账户，分配专门的管理系统</div>
                    </div>
                </div>
            </div>
...
<!-- zhz233-store.js 核心库-->
<script type="text/javascript" src="js/zhz233-store.js"></script>
</html>